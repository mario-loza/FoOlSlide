...
$config['theme_directory'] = 'KITT';
$config['theme_name'] = 'KITT';
$config['theme_description'] = 'The fanciest FoOlSlide theme';
...
$config['theme_extends'] = 'KITT'; // it's ok to refer it to itself, it means there's no fallback
